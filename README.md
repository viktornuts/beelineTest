...
>- [x] *Проверка текста раздела 'Все сервисы'*
>- [x] *Проверка предупреждений при регистрации работодателя c пустыми данными (PajeObj)*
>- [x] *Проверка раздела 'Карьерная консультация'*
>- [x] *Проверка стоимости тарифов готовых резюме'*
